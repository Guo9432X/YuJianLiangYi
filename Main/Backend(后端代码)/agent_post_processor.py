...
import os
import requests
from utils import save_image_to_local   # 统一使用项目中的 utils

# ---------- DeepSeek LLM 客户端（仅 ReAct 模式使用） ----------
class DeepSeekLLM:
    """DeepSeek 推理客户端，用于 ReAct 智能体"""
...
class YoloPostProcessorAgent:
    ...
    def _compensate_small_objects(self, current_boxes, original_boxes):
        return self._compensate_with_params(current_boxes, original_boxes,
